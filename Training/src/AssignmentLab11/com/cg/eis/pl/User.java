package AssignmentLab11.com.cg.eis.pl;
import java.util.Scanner;

import AssignmentLab11.com.cg.eis.bean.Employee;
import AssignmentLab11.com.cg.eis.service.Service;
import AssignmentLab11.conn.DataConnection;
...
public class User {
	...
	public static void main(String[] args) {
		...
		DataConnection dc = new DataConnection(em.getId(),em.getName(),em.getDesignation(),em.getSalary(),em.getInsuranceScheme());
	  System.out.println("\n\n");
	    ser.display();
		dc.insertData();
		scan.close();
